...
/***/ function(module, exports, __webpack_require__) {
	...
	var TestPage = function (_Component) {
	  ...
	  function TestPage(props) {
	    ...
	    var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(TestPage).call(this, props));
	  ...
	  (0, _createClass3.default)(TestPage, [{
	    ...
	    key: 'invokeTest',
	    value: function invokeTest(action) {
	    ...
	    value: function renderMenu() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'btn-group', role: 'group', 'aria-label': 'Menu' },
	        _react2.default.createElement(
	          'button',
	          { type: 'button', className: 'btn btn-default', onClick: this.invokeTest.bind(this, 'datax') },
	          '插入数据'
	        ),
	        _react2.default.createElement(
	          'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TestDatax = function (_Component) {
	  (0, _inherits3.default)(TestDatax, _Component);

	  function TestDatax(props) {
	    (0, _classCallCheck3.default)(this, TestDatax);

	    var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(TestDatax).call(this, props));
	    ...
	    _this.initSensorData();
	    return _this;
	  }

	  (0, _createClass3.default)(TestDatax, [{
	    key: 'setInterval',
	    ...
	    key: 'handleIntervalChange',
	    value: function handleIntervalChange(e) {
	    ...
	    key: 'handleInsertDatax',
	    value: function handleInsertDatax() {
	      var _this2 = this;
	      ...
	      if (updating) {
	        this.setInterval(function () {
	          _this2.state.selectedDeviceArray.map(function (id, index) {
	            var device = _this2.state.devices[id];
	            _this2.insertDatax(device);
	          });
	    ...
	    key: 'randomSensorData',
	    value: function randomSensorData() {
	    ...
	    key: 'insertDatax',
	    value: function insertDatax(device) {
	      // data format:
	      ...
	      $.ajax({
	        ...
	        dataType: "json",
	        success: function (data) {
	          console.log("insertDatax ok:" + (0, _stringify2.default)(data));
	          //alert ("getDeviceList ok:"+JSON.stringify(data));
	        }.bind(this),
	        failure: function (errMsg) {
	          //alert(JSON.stringify(errMsg));
	          console.log("insertDatax failure: " + (0, _stringify2.default)(errMsg));
	        }.bind(this)
	      });
	    }
	  }, {
	    ...
	    value: function renderDeviceCheckBox(device) {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement('input', { type: 'text', className: 'form-control', disable: 'true', value: device.deviceid })
	      );
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      var checkbox_list = this.state.deviceArray.map(function (id) {
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement('input', { className: 'form-control', placeholder: 'set datax update interval...', type: 'text', onChange: this.handleIntervalChange.bind(this), value: this.state.updateInterval }),
	              _react2.default.createElement(
	                'span',
	                { className: 'input-group-btn' },
	                _react2.default.createElement(
	                  'button',
	                  { className: 'btn btn-default', type: 'button', onClick: this.handleInsertDatax.bind(this) },
	                  goOrStop
	                )
	              )
	            )
