...
(224, 'UserCenter', '粉丝营销', '实现3G首页、微信登录，微信用户绑定，微信用户信息初始化等基本功能', 1, '{"score":"100","experience":"100","need_bind":"0","bind_start":"0","jumpurl":""}', '艾逗笔', '1.0', 1455705730, 1, 0, 1, 1),
(225, 'AddressManage', '地址管理', '通用地址管理插件', 1, 'null', '艾逗笔', '1.0', 1455705745, 1, 0, 1, 1),
(226, 'SceneQrcode', '二维码管理', '设置不同的场景生成对应的二维码，用于营销推广、用户绑定、数据统计等场景。', 1, 'null', '艾逗笔', '1.0', 1455705756, 1, 0, 1, 1),
...
(228, 'Example', '功能演示', '对豆信框架的功能进行演示', 1, '{"random":"1"}', '艾逗笔', '1.0', 1455705774, 0, 0, 2, 1),
